  ...
  <va-card class="h-full">
    <va-card-content>
      <div class="grid grid-cols-3 gap-2">
        <va-textarea rows="20" v-model="CLEAN_KWS" label="Insert here the keywords list"
          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />

        <div class="flex flex-col gap-4">
          <h2 class="text-2xl text-center">FILTERS</h2>
          <va-checkbox label="Replace accented letters (á, é, í....) for not accented letters (a, e, i...)"
            v-model="REPLACE_ACCENTS" />
          <va-checkbox label="Remove long tail keywords with more of 10 words" v-model="REMOVE_BIG" />
          <va-checkbox label="Remove unwished characters like + -" v-model="REMOVE_CHARACTERS" />
          <va-checkbox label="Remove duplicated content" v-model="SET_UNIQUES" />
          <button type="button"
            ...
            @click="onClickButtonClear()">Clear keywords</button>
        </div>
        <va-textarea rows="20" v-model="CLEAN_KWS" label="Your cleaned keywords" readonly
          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
      </div>
