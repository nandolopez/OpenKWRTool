<template>
    <div class="flex gap-4 mb-4 row">
        <va-card class="w-full">
            <va-card-title>
                <h1 class="va-h2">KEYWORD RESEARCH OPEN
                    SOURCE TOOL</h1>
            </va-card-title>
            <va-card-content>
                The perfect toolbox for manipulate, classify and structure your keywords.
            </va-card-content>
        </va-card>
    </div>
    <div class="flex gap-4 mb-4 row">
        <va-card color="info" gradient class="md12">
            ...
            <va-card-content>
                <ol class="list-disc p-4">
                    <li class="mb-4">All process executes in your device, this means that performance of the tool it's
                        linked to power of
                        your device.</li>
                    <li class="mb-4">This tool use Localstorage for manage the information (a database integrated in your
                        browser), this
                        means that the limit of information that can process is of 5Mb (around 50K keywords)</li>
                    <li class="mb-4">The tools are under constructions it's possible that could fail or give errors</li>
